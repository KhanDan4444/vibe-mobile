...
export function AppTabBarIcon({
  ...
  const shellWidth = isTablet ? 56 : 46;
  const shellHeight = isTablet ? 34 : 28;
  ...
  return (
    <View style={[styles.wrap, { width: shellWidth, height: shellHeight }]}>
      <Animated.View
        style={[
          styles.shell,
          { minWidth: shellWidth, height: shellHeight, paddingHorizontal: isTablet ? 15 : 11, borderRadius: shellRadius },
          shellStyle,
        ]}
      >
        <Animated.View
